...
//Feedback device who estimates a axis's velocity, by reading the axis's position from a
...
class VelocityDeriver: public FeedbackDevice
{
  private:
    ...
    //The feedback device providing the position data on this axis, so this velocity deriver
  ...
  public:
    ...
    //overview: Calculates how fast the axis is going, by reading position data from a position sensor and
    ...
    //
    //returns:  The present velocity of the axis.
    //
    ...
    //          Two: The function technically is always one reading behind the TRUE present velocity of the axis, since
